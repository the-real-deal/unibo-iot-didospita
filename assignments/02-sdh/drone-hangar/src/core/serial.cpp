...
Message::Message(String message) {
  ...
  this->type = enumFromString<MessageType>(message.substring(0, delimiterIndex),
...
String Message::toString() {
  return enumToString<MessageType>(this->type, MESSAGE_TYPE_STRINGS) +
         Message::DELIMITER + this->content + Message::TERMINATOR;
}
